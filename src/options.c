...
#define IONOPT  "0:off,1:brdc,2:sbas,3:dual-freq,4:est-stec,5:ionex-tec,6:qzs-brdc,7:qzs-lex,8:vtec_sf,9:est-adaptive,10:gtec"
...
#define ARMOPT  "0:off,1:continuous,2:instantaneous,3:fix-and-hold,4:ppp-ar,5:ppp-ar-ils"
#define POSOPT  "0:llh,1:xyz,2:single,3:posfile,4:rinexhead,5:rtcm"
#define TIDEOPT "0:off,1:solid,2:solid+otl-station+pole,3:solid+otl-clasgrid+pole"
#define ALPOPT  "0:0.1%,1:0.5%,2:1%,3:5%,4:10%,5:20%"
#define ISBOPT  "0:off,1:table,2:est,3:est-P,4:est-L,5:est(L:estimate only)"  
#define PHAOPT  "0:off,1:table,2:rinexrtcm"
#define QAROPT  "0:off,1:on,2:gps-qzs"
...
opt_t sysopts[]={
    ...
    {"pos2-qzsarmode",  3,  (void *)&prcopt_.qzsmodear,  QAROPT },
    {"pos2-arthres",    1,  (void *)&prcopt_.thresar[0], ""     },
    {"pos2-aralpha",    3,  (void *)&prcopt_.alphaar,    ALPOPT },
    {"pos2-arlockcnt",  0,  (void *)&prcopt_.minlock,    ""     },
    {"pos2-arminamb",   0,  (void *)&prcopt_.minamb,     ""     },
    {"pos2-arminhold",  0,  (void *)&prcopt_.minhold,    ""     },
    ...
    {"pos2-maxageclk",  1,  (void *)&prcopt_.maxageclk,  "s"    },
    {"pos2-maxageothers",1, (void *)&prcopt_.maxageoth,  "s"    },
    ...
    {"pos2-rejionno1",  1,  (void *)&prcopt_.maxinno[0], "m"    },
    {"pos2-rejionno2",  1,  (void *)&prcopt_.maxinno[1], "m"    },
    {"pos2-rejionno3",  1,  (void *)&prcopt_.maxinno[2], "m"    },
    {"pos2-rejionno4",  1,  (void *)&prcopt_.maxinno[3], "m"    },
    {"pos2-rejionno5",  1,  (void *)&prcopt_.maxinno[4], "m"    },
    ...
    {"pos2-poserrcnt",  0,  (void *)&prcopt_.poserrcnt,  ""     },
    ...
    {"out-statextd",    3,  (void *)&prcopt_.estat,      SWTOPT },
    ...
    {"stats-erriono",   1,  (void *)&prcopt_.err[5],     "m"    },
    {"stats-errtrop",   1,  (void *)&prcopt_.err[6],     "m"    },
    ...
    {"stats-prnposith", 1,  (void *)&prcopt_.prn[5],     "m    "},
    {"stats-prnpositv", 1,  (void *)&prcopt_.prn[6],     "m    "},
    {"stats-prnionomax",1,  (void *)&prcopt_.prn[7],     "m    "},
    {"stats-clkstab",   1,  (void *)&prcopt_.sclkstab,   "s/s"  },
    {"stats-tconstiono",1,  (void *)&prcopt_.beta,       "s"    },
    ...
    {"exterr-gloicbL1", 1,  (void *)&prcopt_.exterr.gloicb[0],"cm/ch"},
    {"exterr-gloicbL2", 1,  (void *)&prcopt_.exterr.gloicb[1],"cm/ch"},
    {"exterr-gloicbL5", 1,  (void *)&prcopt_.exterr.gloicb[2],"cm/ch"},
    {"exterr-gpsglobL1",1,  (void *)&prcopt_.exterr.gpsglob[0],"m"},
    {"exterr-gpsglobL2",1,  (void *)&prcopt_.exterr.gpsglob[1],"m"},
    {"exterr-gpsglobL5",1,  (void *)&prcopt_.exterr.gpsglob[2],"m"},
    {"exterr-ena3",     3,  (void *)&prcopt_.exterr.ena[2],SWTOPT},
 
    {"file-isbfile",    2,  (void *)&filopt_.isb,        ""     },
    {"pos2-isb",        3,  (void *)&prcopt_.isb,        ISBOPT },
    {"file-phacycfile", 2,  (void *)&filopt_.ifpcs,      ""     },
    {"pos2-phasshft",   3,  (void *)&prcopt_.phasshft,   PHAOPT },
    
    {"file-cssrgridfile",2, (void *)&filopt_.grid,       ""     },
    
    {"misc-regularly",  0,  (void *)&prcopt_.regularly,  "s"    },
    {"pos2-isbbyprn",   0,  (void *)&prcopt_.isbbyprn,   SWTOPT },
    {"misc-maxobsloss", 1,  (void *)&prcopt_.maxobsloss, "s"    },
    {"misc-retrycnt",   0,  (void *)&prcopt_.retrycnt,   ""     }, 
    {"misc-epochtoretry",0, (void *)&prcopt_.epochtoretry,""    }, 
    {"misc-floatcnt",   0,  (void *)&prcopt_.floatcnt,   ""     }, 
...
static void buff2sysopts(void)
{
    ...
    if (exsats_[0]!='\0') {
        ...
        for (p=strtok(buff," ");p;p=strtok(NULL," ")) {
            ...
            sys= satsys(sat, &prn);
            trace(1, "exclude satellite: sys=%2d, prn=%3d, sat=%2d, flag=%d\n", sys, prn, sat, prcopt_.exsats[sat-1]);
        }
    }
    /* snrmask */
    for (i=0;i<NFREQ;i++) {
